...
export function Header() {
  ...
  return (
    <header className="group-has-data-[collapsible=offcanvas]/sidebar-wrapper:h-12 flex h-16 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear">
